...
const DataStrCard = () => {
    ...
    const DataStrQuestions = questions.filter((question) => question.category === "Data Structure");

    const handlePrevious = () => {
        setCurrentIndex((prevIndex) =>
            prevIndex === 0 ? DataStrQuestions.length - 1 : prevIndex - 1
        );
    };

    const handleNext = () => {
        setCurrentIndex((prevIndex) =>
            prevIndex === DataStrQuestions.length - 1 ? 0 : prevIndex + 1
        );
    };
    ...
    return (
        <section className="max-w-xl mx-auto px-3 py-4 sm:p-4 bg-gray-50 rounded-lg">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-center">Data Structure Interview Questions</h2>
            ...
            <div className="relative">
                <div className="mb-4">
                    <CardModel
                        question={DataStrQuestions[currentIndex].question}
                        answer={DataStrQuestions[currentIndex].answer}
                    />
                </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-600 font-medium">
                        Question {currentIndex + 1} of {DataStrQuestions.length}
                    </span>
